...
const META = {
  "master-sales-report": [SALES, ["customer_type", "payment_status", "user", "branch", "search", "dates"]],
...
export const REPORT_GROUPS = [SALES, PARTNER, "Purchase Report", "Product Report", "Customer Report", "Supplier Report", "Account Report", "Profit Loss Report", "Vat Report"];
