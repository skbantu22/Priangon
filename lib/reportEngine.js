...
async function figures(ctx) {
  ...
  const [saleTotal, cost, expenses, purchases, returns, posReceived, dueReceived, purchasePaid, supplierPaid, discount, vat, saleReturns, salary, commission] = await Promise.all([
