...
export const sidebarMenu = [
...

  {
    ...
    submenu: [
      ...
      { title: "Transfer", bn: "স্টক স্থানান্তর", url: ADMIN_INVENTORY_TRANSFER, roles: ["admin", "manager"] },
      { title: "Transferred List", bn: "স্থানান্তরিত তালিকা", url: ADMIN_INVENTORY_TRANSFERRED, roles: ["admin", "manager", "cashier"] },
      { title: "Received List", bn: "গৃহীত তালিকা", url: ADMIN_INVENTORY_RECEIVED, roles: ["admin", "manager", "cashier"] },
    ],
  },
