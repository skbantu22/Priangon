...
export const sidebarMenu = [
...

  {
    ...
    url: "#",
    icon: IoReceipt,
    roles: ["admin", "manager", "moderator", "cashier"],
    submenu: [
      ...
      { title: "Showroom Requests", url: "/admin/all-orders/online-orders", roles: ["admin", "manager", "cashier"] },
      { title: "Moderator Orders", url: "/admin/all-orders/moderator", roles: ["admin", "moderator"] },
    ],
  },
...

  {
    ...
    submenu: [
      ...
      { title: "Transfer Stock", url: "/admin/products-confirm", roles: ["admin"] },
      { title: "Edit Stock", url: "/admin/warehouse", roles: ["admin", "manager"] },
      { title: "Showrooms", url: "/admin/showrooms", roles: ["admin", "manager"] },
    ],
  },
