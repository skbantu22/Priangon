...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      ["partnerOrders.view", "See dealer orders"],
      ["partnerOrders.invoice", "Turn a dealer order into an invoice"],
    ],
  },
  {
    key: "warranty",
...
export const SYSTEM_ROLES = {
  ...
  manager: {
    ...
    permissions: [
      ...
      "customers.view", "customers.create", "customers.edit", "customers.due",
      "suppliers.view",
