import { ADMIN_CATEGORY_ADD, ADMIN_CATEGORY_SHOW, ADMIN_COUPON_ADD, ADMIN_COUPON_SHOW, ADMIN_DASHBOARD, ADMIN_MEDIA_SHOW, ADMIN_PRODUCT_ADD, ADMIN_PRODUCT_SHOW } from "@/Route/Adminpannelroute";
...
const searchData = [
   ...
   },
   {
       ...
       description: "Every variant, its barcode, stock and dealer rates",
       url: ADMIN_PRODUCT_SHOW,
