...
export const CUSTOMER_TYPES = {
  ...
  // Stored as "retailer" / retailerPrice since before the rename, so
  // existing customers, users and orders keep working untouched
  retailer: { label: "Wholesaler (পাইকারি)", short: "Wholesaler", field: "retailerPrice" },
};
