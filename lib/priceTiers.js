...
// Example: purchase 600 · dealer 700 · sub dealer 750 · wholesaler 800 · retail 1000
...
export const CUSTOMER_TYPES = {
  ...
  wholesaler: { label: "Wholesaler (পাইকারি)", short: "Wholesaler", field: "wholesalerPrice" },
};
...
export const TIER_PRICE_FIELDS = ["purchasePrice", "dealerPrice", "subDealerPrice", "wholesalerPrice"];
...
// Dealer / sub dealer / wholesaler logins (each linked to a Customer of that type)
...
export const ratesFor = (product, variant) => ({
  ...
  wholesalerPrice: tierRateForVariant(product, variant, "wholesalerPrice"),
});
