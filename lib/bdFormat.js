 ...
 * Anything up to 999.
 *
 * Lakh and thousand never pass 99, but the crore group has no ceiling:
 * 1,50,00,00,000 is "One Hundred Fifty Crore", and reading that group with
 * twoDigits alone runs off the end of TENS and prints "undefined".
 */
const upToThousand = (n) => {
