...
import VatGroupsPanel from "@/components/ui/Application/Admin/settings/VatGroupsPanel";
...
export default function VatSettingsPage() {
  ...
  const rateError =
    form?.vatEnabled && !(rate >= 0 && rate <= 100)
  ...
  const sampleVat = form
    ? form.vatInclusive
      ? vatFromInclusive(SAMPLE, rate)
      : vatOnExclusive(SAMPLE, rate)
    : 0;
              ...
              {form.vatEnabled && (
                <>
                  <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <Field
                      id="vat-mushak"
                      label="Mushak Form No"
                      hint="Retail VAT challan is 6.3"
                    >
                      <input
                        id="vat-mushak"
